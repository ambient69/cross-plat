        ...
        public static string Run(string inputPath, string outputPath)
        {
            ...
            try
            {
                ...
                if (N < 3)
                {
                    ...
                    return "Количество приборов должно быть не менее 3.";
                }
                else
                {
                    ...
                    return "Количество способов выбора приборов: " + iterations;
                }
            }
            ...
            catch (FormatException)
            {
                ...
                return "Некорректный формат данных в файле INPUT.txt.";
            }
            catch (Exception ex)
            {
